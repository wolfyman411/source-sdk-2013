...
void ActivityList_RegisterSharedActivities( void )
{
	...
	//iceaxe
	REGISTER_SHARED_ACTIVITY(ACT_VM_CHARGE); //iceaxe
	REGISTER_SHARED_ACTIVITY(ACT_VM_CHARGE_MISS); //iceaxe
	REGISTER_SHARED_ACTIVITY(ACT_VM_CHARGE_HIT); //iceaxe
	REGISTER_SHARED_ACTIVITY(ACT_VM_CHARGE_IDLE); //iceaxe

	//Xentree
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK);
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK_MISS1); //Xentree
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK_MISS2); //Xentree
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY(ACT_DI_ALYX_FAST_ZOMBIE_SHOTGUN64);
	REGISTER_SHARED_ACTIVITY(ACT_DI_ALYX_FAST_ZOMBIE_SHOTGUN148);
