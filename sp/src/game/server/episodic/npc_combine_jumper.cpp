...
void CNPC_Combine_Jumper::Event_Killed( const CTakeDamageInfo& info )
{
    if ( m_pSpawnedBy )
    {
        m_pSpawnedBy->m_iActiveJumpers--;
    }
...
ConVar sk_npc_dmg_teleportgrenade( "sk_npc_dmg_teleportgrenade", "0" );
...
class CGrenadeTeleport : public CBaseGrenade
{
    ...
    // TODO: Change to TeleportGrenade.Blip
    void	BlipSound() { EmitSound( "Grenade.Blip" ); }
    void	DelayThink();
    void	VPhysicsUpdate( IPhysicsObject* pPhysics );
    void	OnPhysGunPickup( CBasePlayer* pPhysGunUser, PhysGunPickup_t reason );
    bool	IsCombineSpawned( void ) const { return true; }
...
void CGrenadeTeleport::Spawn( void )
{
    ...
    m_flDamage = sk_npc_dmg_teleportgrenade.GetFloat();
...
CBaseGrenade* Teleportgrenade_Create( const Vector& position, const QAngle& angles, const Vector& velocity, const AngularImpulse& angVelocity, CBaseEntity* pOwner, float timer )
{
